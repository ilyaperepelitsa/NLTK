...
working_params = hyper_params["basic_word2vec_ch3_nintendo"]



# pew = json.load("/Volumes/data_pew/text_data/Nintendo_tweets/NintendoTweets.json")
# DATA = pd.read_json("/Volumes/data_pew/text_data/Nintendo_tweets/NintendoTweets.json")

tweets = []
for line in open('/Volumes/data_pew/text_data/Nintendo_tweets/NintendoTweets.json', 'r'):
    if len(line)>1:
        tweets.append(json.loads(line))

# len(tweets)
DATA = pd.DataFrame(tweets)
# DATA = pd.read_csv("/Volumes/data_pew/text_data/Nintendo_tweets/NintendoTweets.json")
# pew
...
# tensorboard --logdir=./logs/basic_word2vec_ch3_nintendo/ --host 127.0.0.1
